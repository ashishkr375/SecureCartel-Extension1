        ...
        },
        {
            ...
            detectionFunctions: [
                function (node, nodeOld) {
                    ...
                    return /\d+\s*(?:\%|pieces?|pcs?\.?|pc?\.?|ct?\.?|items?)?\s*(?:available|sold|claimed|redeemed)|(?:last|final)\s*(?:article|item)|Limited\s*(?:time\s*)?deal|Ending\s*soon|Today\s*deal|ends\s*in/i.test(node.innerText);
                }
            ],
